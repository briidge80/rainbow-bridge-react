...
export const SkullIcon = ({
    ...
    >
        <path
            d="m34 16c0-10-7.163-16-16-16-8.836 0-16 6-16 16 0 5.574.002 10.388 6 12.64v4.36c0 1.657 1.343 3 3 3s3-1.343 3-3v-3.155c.324.027.659.05 1 .07v3.085c0 1.657 1.343 3 3 3s3-1.343 3-3v-3.085c.342-.021.676-.043 1-.07v3.155c0 1.657 1.344 3 3 3 1.657 0 3-1.343 3-3v-4.36c5.998-2.252 6-7.066 6-12.64z"
            fill="#ccd6dd"
        />
        <g fill="#292f33">
            <circle
